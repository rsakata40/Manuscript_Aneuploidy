...
# USER CONFIGURATION
# ============================================================================
ROOT_DIR = "/ceph.groups/mshahbazi.grp/rsakata/HE_EXP179/LIF2TIF"
OUT_DIR = "/ceph.groups/mshahbazi.grp/rsakata/HE_EXP179/cellpose/output/cellpose_boundary"

# Channel names in the TIFF after reordering to Z,C,Y,X.
CHANNEL_ORDER = ["DAPI", "ECAD","BF",  "NANOG", "GATA3", "caspase3"]
...
VOXEL_SIZE_UM =  (2.0, 0.2705629, 0.2705629)
