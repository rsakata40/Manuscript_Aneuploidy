...
#SBATCH --array=0-10%4 #number of files-1 % GPU allowed

# --- Environment -------------------------------------------------------------
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/HE_EXP179/cellpose/code/cellpose_batch.sh
...
python /ceph.groups/mshahbazi.grp/rsakata/HE_EXP179/cellpose/code/cellpose_batch.py
