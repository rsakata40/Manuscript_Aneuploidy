...
#SBATCH --array=0-10%8 #number of files-1 % GPU allowed

# --- Environment -------------------------------------------------------------
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/HE_EXP179/cellpose/code/cellpose_boundary.sh
...
python /ceph.groups/mshahbazi.grp/rsakata/HE_EXP179/cellpose/code/cellpose_boundary_v3.py