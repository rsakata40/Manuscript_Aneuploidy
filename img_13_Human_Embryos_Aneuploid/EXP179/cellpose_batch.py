...
# --------- USER CONFIG ---------
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_EXP179/LIF2TIF'       # folder with .tif/.tiff
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_EXP179/cellpose/output/1_cellpose'
mask_dir = "/ceph.groups/mshahbazi.grp/rsakata/HE_EXP179/cellpose/output/1_cellpose_mask"
out_dir = OUT_DIR
...
CHANNEL_ORDER = ["dapi", "GATA4","BF",  "NANOG", "GATA3", "caspase3"]  # edit names/order to match your data
