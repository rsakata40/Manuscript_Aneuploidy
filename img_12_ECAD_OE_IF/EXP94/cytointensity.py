...
# ---------------- CONFIG ----------------
DIR_IMG = "/ceph.groups/mshahbazi.grp/rsakata/EXP94/all/LIF2TIF"         # images: Z,C,Y,X
DIR_NUC = "/ceph.groups/mshahbazi.grp/rsakata/EXP94/all/cellpose/output/1_cellpose_mask"    # nuclear masks: Z,Y,X  (filename: <file>_cp_mask.tif/.tiff)
DIR_SPH = "/ceph.groups/mshahbazi.grp/rsakata/EXP94/all/cellpose/output/2_cytoseg"            # spheroid masks: Z,Y,X (filename: <file>_mask.tif/.tiff)
OUT_DIR = "/ceph.groups/mshahbazi.grp/rsakata/EXP94/all/cellpose/output/3_cytomask_intensities"
out_csv = os.path.join(OUT_DIR, f"cyto_intensity.csv")

os.makedirs(OUT_DIR, exist_ok=True)

# number of channels & names (in the order they appear along C)
N_CHANNELS    = 6
CHANNEL_NAMES = ["DAPI", "GATA3", "BF", "GFP", "mcherry", "NANOG"]  # edit to match your data
