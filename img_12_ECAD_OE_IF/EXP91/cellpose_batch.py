...
# --------- USER CONFIG ---------
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP91/LIF2TIF/cropped2'       # folder with .tif/.tiff
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP91/cellpose/output/1_cellpose'
mask_dir = "/ceph.groups/mshahbazi.grp/rsakata/EXP91/cellpose/output/1_cellpose_mask"
out_dir = OUT_DIR
...
CHANNEL_ORDER = ["dapi", "GATA3", "GFP", "mcherry", "NANOG"]  # edit names/order to match your data
NUC_NAME      = "dapi"                                # nuclear channel name used for segmentation

# Voxel size (µm) and optional min volume (µm³) filter for objects
voxel_size_um = (2.0, 0.669, 0.669)     # (z_um, y_um, x_um) — edit!
