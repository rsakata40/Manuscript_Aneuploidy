...
# ===================================================
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP58/LIF2TIF/setB_T2/LIF2TIF'   # Input folder
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP58/output/setB_T2/cellpose_boundary' # Output folder
