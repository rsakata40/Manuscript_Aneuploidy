...
#SBATCH --array=0-55%8 #number of files-1 % GPU allowed

# --- Environment -------------------------------------------------------------
#cd /ceph.groups/mshahbazi.grp/rsakata/EXP58/code/setB_T3
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP58/code/setB_T3/cytoseg.sh
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/EXP58/code/setB_T3/cytoseg.py 