...
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/EXP58/code/setA_T3/log/1800-%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/EXP58/code/setA_T3/log/1800-%x-%j.err
...
# --- Environment -------------------------------------------------------------
#cd /ceph.groups/mshahbazi.grp/rsakata/EXP58/code/setA_T3
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP58/code/setA_T3/cytoseg.sh
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/EXP58/code/setA_T3/cytoseg.py 