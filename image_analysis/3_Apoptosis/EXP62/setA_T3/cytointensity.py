...
# ---------------- CONFIG ----------------
DIR_IMG = "/ceph.groups/mshahbazi.grp/rsakata/EXP62/LIF2TIF/setA_T3"         # images: Z,C,Y,X
DIR_NUC = "/ceph.groups/mshahbazi.grp/rsakata/EXP62/output/setA_T3/1_cellpose_mask"    # nuclear masks: Z,Y,X  (filename: <file>_cp_mask.tif/.tiff)
DIR_SPH = "/ceph.groups/mshahbazi.grp/rsakata/EXP62/output/setA_T3/2_cytoseg"            # spheroid masks: Z,Y,X (filename: <file>_mask.tif/.tiff)
OUT_DIR = "/ceph.groups/mshahbazi.grp/rsakata/EXP62/output/setA_T3/3_cytomask_intensities"
