...
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setA_T2/log/%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setA_T2/log/%x-%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=rsakata@mrc-lmb.cam.ac.uk

#SBATCH --array=0-42%8 #number of files-1 % GPU allowed

# --- Environment -------------------------------------------------------------
#cd /ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setA_T2
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setA_T2/cytoseg.sh
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setA_T2/cytoseg.py 