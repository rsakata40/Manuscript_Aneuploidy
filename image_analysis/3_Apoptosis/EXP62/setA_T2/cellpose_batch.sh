...
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setA_T2/cellpose_batch.sh
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setA_T2/cellpose_batch.py 