...
# ===================================================
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP63/LIF2TIF/setB_T3'   # Input folder
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP63/output/setB_T3/cellpose_boundary' # Output folder
