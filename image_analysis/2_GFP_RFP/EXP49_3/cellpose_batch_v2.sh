...
#SBATCH --mem=200G
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/EXP49/code/batch3/log/%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/EXP49/code/batch3/log/%x-%j.err
...
#SBATCH --array=0-22%4 #number of files-1 % GPU allowed

# --- Environment -------------------------------------------------------------
#cd /ceph.groups/mshahbazi.grp/rsakata/EXP49/cellpose/code
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP49/code/batch3/cellpose_batch_v2.sh
...
python /ceph.groups/mshahbazi.grp/rsakata/EXP49/code/batch3/cellpose_batch_v2.py
