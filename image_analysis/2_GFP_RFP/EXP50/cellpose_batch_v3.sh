...
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP50/cellpose_withstruc/code/cellpose_batch_v3.sh
...
python /ceph.groups/mshahbazi.grp/rsakata/EXP50/cellpose_withstruc/code/cellpose_batch_v3.py 
