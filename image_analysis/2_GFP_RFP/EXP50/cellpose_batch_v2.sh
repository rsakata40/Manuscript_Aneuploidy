...
#SBATCH --mem=200G
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/EXP50/cellpose_withstruc/code/output/2246-%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/EXP50/cellpose_withstruc/code/output/2246-%x-%j.err
...
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP50/cellpose_withstruc/code/cellpose_batch_v2.sh
...
python /ceph.groups/mshahbazi.grp/rsakata/EXP50/cellpose_withstruc/code/cellpose_batch_v2.py 
