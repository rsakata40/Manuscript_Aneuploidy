...
#SBATCH --mem=100G
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/EXP50/cellpose_withstruc/code/output/1724-%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/EXP50/cellpose_withstruc/code/output/1724-%x-%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=rsakata@mrc-lmb.cam.ac.uk

# Optional: run as an array (one file per task). Uncomment and set range:
#SBATCH --array=0-24%4 #number of files-1 % GPU allowed

# --- Environment -------------------------------------------------------------
# Usage:
#   sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP50/cellpose_withstruc/code/structureseg_batch_fast.sh
...
cd /ceph.groups/mshahbazi.grp/rsakata/EXP50/cellpose_withstruc/code
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/EXP50/cellpose_withstruc/code/structureseg_batch_fast.py
