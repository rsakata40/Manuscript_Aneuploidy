...
# --------- USER CONFIG ---------
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP95/LIF2TIF/setA'       # folder with .tif/.tiff
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP95/cellpose/output/setA/1_cellpose'
mask_dir = "/ceph.groups/mshahbazi.grp/rsakata/EXP95/cellpose/output/setA/1_cellpose_mask"
out_dir = OUT_DIR
...
CHANNEL_ORDER = ["dapi", "GATA3", "BF", "NANOG", "ECAD"]  # edit names/order to match your data
