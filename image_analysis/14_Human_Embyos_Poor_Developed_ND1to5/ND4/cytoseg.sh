...
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping4/code/log/%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping4/code/log/%x-%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=rsakata@mrc-lmb.cam.ac.uk

#SBATCH --array=0-4%4 #number of files-1 % GPU allowed

# --- Environment -------------------------------------------------------------
#cd /ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping4/code
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping4/code/cytoseg.sh
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping4/code/cytoseg.py