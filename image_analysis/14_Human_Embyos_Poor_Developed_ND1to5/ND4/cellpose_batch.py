...
# --------- USER CONFIG ---------
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping4/LIF2TIF'       # folder with .tif/.tiff
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping4/output/cellpose_intensities'
mask_dir = "/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping4/output/nuclear_mask"
out_dir = OUT_DIR
...
CHANNEL_ORDER = ["dapi", "GATA4", "NANOG", "GATA3", "ECAD"]  # edit names/order to match your data
NUC_NAME      = "dapi"                                # nuclear channel name used for segmentation

# Voxel size (µm) and optional min volume (µm³) filter for objects
voxel_size_um = (1.0, 0.5687380, 0.5687380)     # (z_um, y_um, x_um) — edit!
