...
# --- Environment -------------------------------------------------------------
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping4/code/cellpose_boundary.sh
...
python /ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping4/code/cellpose_boundary_v3.py