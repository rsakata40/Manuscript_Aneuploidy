...
# ===================================================
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping1/LIF2TIF'   # Input folder
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping1/output/cellpose_boundary' # Output folder
