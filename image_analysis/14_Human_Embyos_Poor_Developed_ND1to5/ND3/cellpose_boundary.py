...
# ===================================================
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping3/LIF2TIF'   # Input folder
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping3/output/cellpose_boundary' # Output folder
...
def reorder_tiff_to_zcxy(img):
    ...
    for i, dim in enumerate(shape):
        if dim < 6: dim_map['C'] = i
        elif 6 < d < 500: dim_map['Z'] = i
        else:
...
def process_single_file(img_path, sample_name):
    ...
    # ---------------- PEAK ALIGNMENT ----------------
    ph_peaks = df_long[df_long["channel"] == "ECAD"].groupby(["z", "label_i", "label_j"])["normalized_intensity"].idxmax()
