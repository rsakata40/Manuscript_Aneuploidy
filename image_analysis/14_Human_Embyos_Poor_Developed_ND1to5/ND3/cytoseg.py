...
OUT_DIR  = '/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping3/output/cyto_mask'

# Voxel size (µm/pixel)
z_spacing_um_per_px  = 2.0
xy_spacing_um_per_px = 0.3787879  # assumed isotropic in XY
