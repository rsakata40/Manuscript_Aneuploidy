...
# ===================== CONFIG =====================
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping5/LIF2TIF'
OUT_DIR  = '/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping5/output/cyto_mask'

# Voxel size (µm/pixel)
z_spacing_um_per_px  = 2.0
xy_spacing_um_per_px = 0.2705629  # assumed isotropic in XY
