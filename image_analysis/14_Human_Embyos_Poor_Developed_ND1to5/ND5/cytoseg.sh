...
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping5/code/log/%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping5/code/log/%x-%j.err
...
# --- Environment -------------------------------------------------------------
#cd /ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping5/code
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping5/code/cytoseg.sh
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping5/code/cytoseg.py