...
# --------- USER CONFIG ---------
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping5/LIF2TIF'       # folder with .tif/.tiff
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping5/output/cellpose_intensities'
mask_dir = "/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping5/output/nuclear_mask"
out_dir = OUT_DIR
