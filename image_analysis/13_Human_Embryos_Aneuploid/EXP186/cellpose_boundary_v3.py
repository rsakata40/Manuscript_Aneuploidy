...
# USER CONFIGURATION
# ============================================================================
ROOT_DIR = "/ceph.groups/mshahbazi.grp/rsakata/HE_EXP186/LIF2TIF"
OUT_DIR = "/ceph.groups/mshahbazi.grp/rsakata/HE_EXP186/cellpose/output/cellpose_boundary"

# Channel names in the TIFF after reordering to Z,C,Y,X.
CHANNEL_ORDER = ["DAPI", "ECAD","BF",  "NANOG", "GATA3", "GATA4"]
...
VOXEL_SIZE_UM =  (2.0, 0.7583174, 0.7583174) 
