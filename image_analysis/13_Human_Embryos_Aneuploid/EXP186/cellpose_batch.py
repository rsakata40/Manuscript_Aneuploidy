...
# --------- USER CONFIG ---------
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_EXP186/LIF2TIF'       # folder with .tif/.tiff
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_EXP186/cellpose/output/1_cellpose'
mask_dir = "/ceph.groups/mshahbazi.grp/rsakata/HE_EXP186/cellpose/output/1_cellpose_mask"
out_dir = OUT_DIR
...
CHANNEL_ORDER = ["dapi", "ECAD","BF",  "NANOG", "GATA3", "GATA4"]  # edit names/order to match your data
