...
# ---------------- CONFIG ----------------
DIR_IMG = "/ceph.groups/mshahbazi.grp/rsakata/EXP56/LIF2TIF/setB"         # images: Z,C,Y,X
DIR_NUC = "/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/nuclear_mask/setB"    # nuclear masks: Z,Y,X  (filename: <file>_cp_mask.tif/.tiff)
DIR_SPH = "/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/cyto_mask/setB"            # spheroid masks: Z,Y,X (filename: <file>_mask.tif/.tiff)
OUT_DIR = "/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/cytomask_intensities"
out_csv = os.path.join(OUT_DIR, f"setB_cyto_intensity.csv")

os.makedirs(OUT_DIR, exist_ok=True)

# number of channels & names (in the order they appear along C)
N_CHANNELS    = 5
CHANNEL_NAMES = ["dapi", "NANOG", "GFP", "ECAD", "GATA6"]  # edit to match your data
