...
# --------- USER CONFIG ---------
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP56/LIF2TIF/setB'       # folder with .tif/.tiff
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/cellpose_intensities/setB'
mask_dir = "/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/nuclear_mask/setB"
out_dir = OUT_DIR
...
CHANNEL_ORDER = ["dapi", "NANOG", "GFP", "ECAD", "GATA6"]  # edit names/order to match your data
