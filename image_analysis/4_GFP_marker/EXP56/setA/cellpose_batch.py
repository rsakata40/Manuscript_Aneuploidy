...
# --------- USER CONFIG ---------
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP56/LIF2TIF/setA'       # folder with .tif/.tiff
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/cellpose_intensities/setA'
mask_dir = "/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/nuclear_mask/setA"
out_dir = OUT_DIR
