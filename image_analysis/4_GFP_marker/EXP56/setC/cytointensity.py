...
# ---------------- CONFIG ----------------
DIR_IMG = "/ceph.groups/mshahbazi.grp/rsakata/EXP56/LIF2TIF/setC"         # images: Z,C,Y,X
DIR_NUC = "/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/nuclear_mask/setC"    # nuclear masks: Z,Y,X  (filename: <file>_cp_mask.tif/.tiff)
DIR_SPH = "/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/cyto_mask/setC"            # spheroid masks: Z,Y,X (filename: <file>_mask.tif/.tiff)
OUT_DIR = "/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/cytomask_intensities"
out_csv = os.path.join(OUT_DIR, f"setC_cyto_intensity.csv")

os.makedirs(OUT_DIR, exist_ok=True)

# number of channels & names (in the order they appear along C)
N_CHANNELS    = 4
CHANNEL_NAMES = ["dapi", "CDX2", "GFP", "RFP"]  # edit to match your data
