...
# --- Environment -------------------------------------------------------------
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP91/cellpose/code/cellpose_batch.sh
...
python /ceph.groups/mshahbazi.grp/rsakata/EXP91/cellpose/code/cellpose_batch.py
