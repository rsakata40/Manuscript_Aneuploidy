...
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/EXP80/cellpose/log/%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/EXP80/cellpose/log/%x-%j.err
#SBATCH --mail-type=END
#SBATCH --mail-user=rsakata@mrc-lmb.cam.ac.uk

#SBATCH --array=0-46%4 #number of files-1 % GPU allowed

# --- Environment -------------------------------------------------------------
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP80/cellpose/cellpose_batch.sh
...
python /ceph.groups/mshahbazi.grp/rsakata/EXP80/cellpose/cellpose_batch.py
