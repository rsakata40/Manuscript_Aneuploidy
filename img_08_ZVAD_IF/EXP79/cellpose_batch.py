...
# --------- USER CONFIG ---------
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP79/LIF2TIF'       # folder with .tif/.tiff
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP79/cellpose/1_cellpose'
mask_dir = "/ceph.groups/mshahbazi.grp/rsakata/EXP79/cellpose/1_cellpose_mask"
out_dir = OUT_DIR
...
CHANNEL_ORDER = ["dapi", "NANOG","GFP", "ECAD", "GATA3"]  # edit names/order to match your data
NUC_NAME      = "dapi"                                # nuclear channel name used for segmentation

# Voxel size (µm) and optional min volume (µm³) filter for objects
voxel_size_um = (2.0, 0.6691035, 0.6691035)     # (z_um, y_um, x_um) — edit!
