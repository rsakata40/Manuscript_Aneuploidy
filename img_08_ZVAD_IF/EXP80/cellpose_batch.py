...
# --------- USER CONFIG ---------
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP80/LIF2TIF'       # folder with .tif/.tiff
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP80/cellpose/1_cellpose'
mask_dir = "/ceph.groups/mshahbazi.grp/rsakata/EXP80/cellpose/1_cellpose_mask"
out_dir = OUT_DIR
