...
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/HE_EXP135/cellpose/code/output/1710-%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/HE_EXP135/cellpose/code/output/1710-%x-%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=rsakata@mrc-lmb.cam.ac.uk

#SBATCH --array=0-45%4 #number of files-1 % GPU allowed

# --- Environment -------------------------------------------------------------
#cd /ceph.groups/mshahbazi.grp/rsakata/EXP51/cellpose/code
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/HE_EXP135/cellpose/code/cellpose_batch.sh
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/HE_EXP135/cellpose/code/cellpose_batch.py 