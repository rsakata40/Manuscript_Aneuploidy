...
#SBATCH --mem=100G
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/HE_EXP135/cellpose/code/output/1755-%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/HE_EXP135/cellpose/code/output/1755-%x-%j.err
...
# --- Environment -------------------------------------------------------------
# Usage:
#   sbatch /ceph.groups/mshahbazi.grp/rsakata/HE_EXP135/cellpose/code/cytointensity.sh
...
cd /ceph.groups/mshahbazi.grp/rsakata/HE_EXP135/cellpose/code
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/HE_EXP135/cellpose/code/cytointensity.py
