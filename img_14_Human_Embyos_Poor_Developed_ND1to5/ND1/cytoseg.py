...
# ===================== CONFIG =====================
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_EXP135/LIF2TIF'
OUT_DIR  = '/ceph.groups/mshahbazi.grp/rsakata/HE_EXP135/cellpose/cyto_mask'

# Voxel size (µm/pixel)
z_spacing_um_per_px  = 2.0
xy_spacing_um_per_px = 0.5687380  # assumed isotropic in XY
