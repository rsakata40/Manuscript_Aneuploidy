...
# ===================================================
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping4/LIF2TIF'   # Input folder
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping4/output/cellpose_boundary' # Output folder
