...
#SBATCH --mem=100G
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping4/cellpose/code/log/%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping4/cellpose/code/log/%x-%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=rsakata@mrc-lmb.cam.ac.uk

# Optional: run as an array (one file per task). Uncomment and set range:
#SBATCH --array=0-5%4 #number of files-1 % GPU allowed

# --- Environment -------------------------------------------------------------
# Usage:
#   sbatch /ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping4/code/cytointensity.sh
...
cd /ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping4/cellpose/code
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping4/code/cytointensity.py
