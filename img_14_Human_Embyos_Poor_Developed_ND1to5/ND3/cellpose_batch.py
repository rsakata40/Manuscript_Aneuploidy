...
# --------- USER CONFIG ---------
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping3/LIF2TIF'       # folder with .tif/.tiff
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping3/output/cellpose_intensities'
mask_dir = "/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping3/output/nuclear_mask"
out_dir = OUT_DIR
...
voxel_size_um = (2.0, 0.3787879, 0.3786121)     # (z_um, y_um, x_um) — edit!
