...
#SBATCH --mem=100G
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping2/cellpose/code/log/%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping2/cellpose/code/log/%x-%j.err
...
# --- Environment -------------------------------------------------------------
# Usage:
#   sbatch /ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping2/code/cytointensity.sh
...
cd /ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping2/cellpose/code
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/HE_Nondeveloping2/code/cytointensity.py
