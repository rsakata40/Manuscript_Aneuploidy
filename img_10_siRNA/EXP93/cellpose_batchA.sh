...
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/EXP93/cellpose/code/log/%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/EXP93/cellpose/code/log/%x-%j.err
#SBATCH --mail-type=END
#SBATCH --mail-user=rsakata@mrc-lmb.cam.ac.uk

#SBATCH --array=0-38%8 #number of files-1 % GPU allowed

# --- Environment -------------------------------------------------------------
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP93/cellpose/code/cellpose_batchA.sh
...
python /ceph.groups/mshahbazi.grp/rsakata/EXP93/cellpose/code/cellpose_batchA.py
