...
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/EXP48/cellpose/code/output/1830-%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/EXP48/cellpose/code/output/1830-%x-%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=rsakata@mrc-lmb.cam.ac.uk

#SBATCH --array=0-102%4 #number of files-1 % GPU allowed

# --- Environment -------------------------------------------------------------
#cd /ceph.groups/mshahbazi.grp/rsakata/EXP48/cellpose/code
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP48/cellpose/code/cellpose_batch.sh
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/EXP48/cellpose/code/cellpose_batch.py 