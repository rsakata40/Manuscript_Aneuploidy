...
#SBATCH --mem=200G
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/EXP48/cellpose/code/output/1220-%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/EXP48/cellpose/code/output/1220-%x-%j.err
...
#SBATCH --array=0-90%4 #number of files-1 % GPU allowed

# --- Environment -------------------------------------------------------------
#cd /ceph.groups/mshahbazi.grp/rsakata/EXP48/cellpose/code
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP48/cellpose/code/cellpose_batch_v2.sh
...
python /ceph.groups/mshahbazi.grp/rsakata/EXP48/cellpose/code/cellpose_batch_v2.py 
