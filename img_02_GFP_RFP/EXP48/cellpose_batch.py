...
# --------- USER CONFIG ---------
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP48/LIF2TIF'       # folder with .tif/.tiff
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP48/cellpose/cellpose_intensities'
mask_dir = "/ceph.groups/mshahbazi.grp/rsakata/EXP48/cellpose/nuclear_mask"
out_dir = OUT_DIR
...
CHANNEL_ORDER = ["dapi", "Phalloidin", "GFP", "mcherry"]  # edit names/order to match your data
