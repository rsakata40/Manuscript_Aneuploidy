...
# --------- USER CONFIG ---------
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP49/LIF2TIF/batch3'    # <— change
outdir = '/ceph.groups/mshahbazi.grp/rsakata/EXP49/output/batch3'
...
SPH_LABELS_DIR = None #"/ceph.groups/mshahbazi.grp/rsakata/EXP49/cellpose/mask"    # set this
