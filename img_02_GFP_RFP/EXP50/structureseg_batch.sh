...
#SBATCH --cpus-per-task=8         # give the loader some cores
...
# --- Environment -------------------------------------------------------------
# before run cd /ceph.groups/mshahbazi.grp/rsakata/EXP50/cellpose_withstruc/code
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP50/cellpose_withstruc/code/structureseg_batch.sh
...
python /ceph.groups/mshahbazi.grp/rsakata/EXP50/cellpose_withstruc/code/structureseg_batch.py 
