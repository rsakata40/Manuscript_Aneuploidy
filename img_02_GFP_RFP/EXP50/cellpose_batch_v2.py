...
outdir = '/ceph.groups/mshahbazi.grp/rsakata/EXP50/cellpose_withstruc/cellpose_intensities'
remove_from_file_name = None  # <— change if needed
minV_um3 = 800.0    # µm³

zum = 1.9998570 #the um/pixel ratio in Z
xyum = 0.3787879 #the um/pixel ratio in Z
...
SPH_LABELS_DIR = "/ceph.groups/mshahbazi.grp/rsakata/EXP50/cellpose_withstruc/mask"    # set this
SPH_SUFFIX = "_mask.tif"                # e.g. "<sample>_spheroids.tif" in SPH_LABELS_DIR
