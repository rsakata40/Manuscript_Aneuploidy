...
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/EXP63/code/setA_T3/log/%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/EXP63/code/setA_T3/log/%x-%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=rsakata@mrc-lmb.cam.ac.uk

#SBATCH --array=0-44%8 #number of files-1 % GPU allowed

# --- Environment -------------------------------------------------------------
#cd /ceph.groups/mshahbazi.grp/rsakata/EXP63/code/setA_T3
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP63/code/setA_T3/cytoseg.sh
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/EXP63/code/setA_T3/cytoseg.py 