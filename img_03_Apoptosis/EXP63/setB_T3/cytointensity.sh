...
#SBATCH --mem=100G
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/EXP63/code/setB_T3/log/2000-%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/EXP63/code/setB_T3/log/2000-%x-%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=rsakata@mrc-lmb.cam.ac.uk

# Optional: run as an array (one file per task). Uncomment and set range:
#SBATCH --array=0-1%4 #number of files-1 % GPU allowed

# --- Environment -------------------------------------------------------------
# Usage:
#   sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP63/code/setB_T3/cytointensity.sh
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/EXP63/code/setB_T3/cytointensity.py
