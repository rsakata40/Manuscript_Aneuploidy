...
#SBATCH --mem=100G
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setB_T3/log/2000-%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setB_T3/log/2000-%x-%j.err
...
# --- Environment -------------------------------------------------------------
# Usage:
#   sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setB_T3/cytointensity.sh
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setB_T3/cytointensity.py
