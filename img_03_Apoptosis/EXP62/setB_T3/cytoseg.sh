...
# --- Environment -------------------------------------------------------------
#cd /ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setB_T3
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setB_T3/cytoseg.sh
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setB_T3/cytoseg.py 