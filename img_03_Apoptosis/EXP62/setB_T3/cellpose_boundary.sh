...
#SBATCH --array=0-146%8 #numberscancel  of files-1 % GPU allowed

# --- Environment -------------------------------------------------------------
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setB_T3/cellpose_boundary.sh
...
python /ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setB_T3/cellpose_boundary.py