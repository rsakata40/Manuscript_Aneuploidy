...
# --------- USER CONFIG ---------
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP62/LIF2TIF/setB_T2'       # folder with .tif/.tiff
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP62/output/setB_T2/1_cellpose'
mask_dir = "/ceph.groups/mshahbazi.grp/rsakata/EXP62/output/setB_T2/1_cellpose_mask"
out_dir = OUT_DIR
