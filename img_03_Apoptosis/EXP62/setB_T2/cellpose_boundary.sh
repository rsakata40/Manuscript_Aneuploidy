...
# --- Environment -------------------------------------------------------------
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setB_T2/cellpose_boundary.sh
...
python /ceph.groups/mshahbazi.grp/rsakata/EXP62/code/setB_T2/cellpose_boundary.py