...
# --------- USER CONFIG ---------
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP62/LIF2TIF/setA_T2'       # folder with .tif/.tiff
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP62/output/setA_T2/1_cellpose'
mask_dir = "/ceph.groups/mshahbazi.grp/rsakata/EXP62/output/setA_T2/1_cellpose_mask"
out_dir = OUT_DIR
...
voxel_size_um = (2.0, 0.7623174, 0.7623174)     # (z_um, y_um, x_um) — edit!
