...
# ===================== CONFIG =====================
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP62/LIF2TIF/setA_T3'
OUT_DIR  = '/ceph.groups/mshahbazi.grp/rsakata/EXP62/output/setA_T3/2_cytoseg'

# Voxel size (µm/pixel)
z_spacing_um_per_px  = 2.0
xy_spacing_um_per_px = 0.7623174   # assumed isotropic in XY
