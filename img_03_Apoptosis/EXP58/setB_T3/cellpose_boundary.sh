...
#SBATCH --mem=200G
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/EXP58/code/setB_T3/log/2321slurm-%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/EXP58/code/setB_T3/log/2321slurm-%x-%j.err
...
# --- Environment -------------------------------------------------------------
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP58/code/setB_T3/cellpose_boundary.sh
...
python /ceph.groups/mshahbazi.grp/rsakata/EXP58/code/setB_T3/cellpose_boundary.py