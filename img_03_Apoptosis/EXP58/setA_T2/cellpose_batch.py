...
# --------- USER CONFIG ---------
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP58/LIF2TIF/setA_T2/LIF2TIF'       # folder with .tif/.tiff
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP58/output/setA_T2/1_cellpose'
mask_dir = "/ceph.groups/mshahbazi.grp/rsakata/EXP58/output/setA_T2/1_cellpose_mask"
out_dir = OUT_DIR
