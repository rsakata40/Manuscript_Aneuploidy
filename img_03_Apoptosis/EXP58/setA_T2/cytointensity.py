...
# ---------------- CONFIG ----------------
DIR_IMG = "/ceph.groups/mshahbazi.grp/rsakata/EXP58/LIF2TIF/setA_T2/LIF2TIF"         # images: Z,C,Y,X
DIR_NUC = "/ceph.groups/mshahbazi.grp/rsakata/EXP58/output/setA_T2/1_cellpose_mask"    # nuclear masks: Z,Y,X  (filename: <file>_cp_mask.tif/.tiff)
DIR_SPH = "/ceph.groups/mshahbazi.grp/rsakata/EXP58/output/setA_T2/2_cytoseg"            # spheroid masks: Z,Y,X (filename: <file>_mask.tif/.tiff)
OUT_DIR = "/ceph.groups/mshahbazi.grp/rsakata/EXP58/output/setA_T2/3_cytomask_intensities"
