...
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code/setC/output/2008-%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code/setC/output/2008-%x-%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=rsakata@mrc-lmb.cam.ac.uk

#SBATCH --array=0-41%4 #number of files-1 % GPU allowed

# --- Environment -------------------------------------------------------------
#cd /ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code/setC/cellpose_batch.sh
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code/setC/cellpose_batch.py 