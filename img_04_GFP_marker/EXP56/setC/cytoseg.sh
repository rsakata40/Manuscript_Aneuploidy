...
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code/setC/output/0205-%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code/setC/output/0205-%x-%j.err
...
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code/setC/cytoseg.sh
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code/setC/cytoseg.py 