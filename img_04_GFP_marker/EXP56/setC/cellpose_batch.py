...
# --------- USER CONFIG ---------
ROOT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP56/LIF2TIF/setC/split'       # folder with .tif/.tiff
OUT_DIR = '/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/cellpose_intensities/setC'
mask_dir = "/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/nuclear_mask/setC"
out_dir = OUT_DIR
...
CHANNEL_ORDER = ["dapi", "CDX2", "GFP", "RFP", "Integrin"]  # edit names/order to match your data
