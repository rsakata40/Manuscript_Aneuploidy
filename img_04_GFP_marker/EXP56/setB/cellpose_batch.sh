...
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code/setB/output/2008-%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code/setB/output/2008-%x-%j.err
...
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code/setB/cellpose_batch.sh
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code/setB/cellpose_batch.py 