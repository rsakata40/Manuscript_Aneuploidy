...
#SBATCH --output=/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code/setA/output/2138-%x-%j.out
#SBATCH --error=/ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code/setA/output/2138-%x-%j.err
...
# --- Environment -------------------------------------------------------------
#cd /ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code
#run by sbatch /ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code/setA/cellpose_batch.sh
...
/usr/bin/time -v \
python /ceph.groups/mshahbazi.grp/rsakata/EXP56/cellpose/code/setA/cellpose_batch.py 